...
# :warning: _includes/code/rolling_hash.cpp

<a href="../../../index.html">Back to top page</a>

* category: <a href="../../../index.html#b46effe2a00fceb0770301fd2a31d561">_includes/code</a>
* <a href="{{ site.github.repository_url }}/blob/master/_includes/code/rolling_hash.cpp">View this file on GitHub</a>
    - Last commit date: 2019-09-16 20:13:31+09:00
...
{% raw %}
```cpp
#line 1 "_includes/code/rolling_hash.cpp"
class xor_shift {
    uint32_t x, y, z, w;
public:
    xor_shift() : x(static_cast<uint32_t>((chrono::system_clock::now().time_since_epoch().count())&((1LL << 32)-1))),
